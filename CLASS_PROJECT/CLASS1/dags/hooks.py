...
# hook is a component that allows us to connect to a database, for example, and execute queries but it is not a provider. it a class
# it is of low level. we can create the same task created by provider with it but we need to write more code
